...
\section{\cspm}
\cspm is a formal language where CSP is combined with a functional programming language in order to make it easier for the programmer to model the systems and then use the code on tools that can animate or verify or similar. \cspm 
\section{FDR}
