...
\title[Master's thesis defense]{Master's thesis defense}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Linedetect example
% TODO: Change to my own linedetect figure
...
\begin{block}{}
% TODO conclude something - can it be used?
...
\begin{frame}{Conclusions}
        \begin{itemize}
            \item I have developed a translation model from SMEIL to \cspm{}
            \item TAPS include verification properties in order to verify the program in FDR4
            \item Extended the solution to verify more than one clock cycle
            \item Runtime experiments show promising results
        \end{itemize}
\textbf{Questions?}
\end{frame}
