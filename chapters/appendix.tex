...
\chapter{Seven Segments Display Example Full SMEIL and \cspm code}
...
\end{minted}
\captionof{listing}{The full \cspm{} code after transpiling the Addone example, as seen in Listing~\ref{lst:smeil_addone_full} in the appendix.\label{lst:cspm_addone_full}}
