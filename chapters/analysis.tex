...
\\
%TODO: Figure out if I should change the python example to also show the actual result
\begin{listing}
\begin{minted}{python}
...
% TODO: Add an example here! it is difficult to understand without more context
