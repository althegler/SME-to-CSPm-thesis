...
% TODO: Decide if this should be add example or double example
\begin{listing}
\begin{minted}{smeil_lexer.py:SMEILLexer -x}
proc add (in input)
    bus addbus {
...
% TODO: Can this be the clock example instead?
\begin{listing}
\begin{minted}{smeil_lexer.py:SMEILLexer -x}
