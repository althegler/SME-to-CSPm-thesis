...
% (previously written)
% The gap between hardware description languages and formal verification such as
%
% the problem lies in providing a solution that brings the traditional trained programmer closer to the area of expertice needed to develop software for mission critical embedded devices. \\
...
\section{Contributions} %TODO: Is this too much like the approach part?
