...
It is possible to have as many monitor processes as needed in the network. The since they dont change the functionality of the system, they can be added without problems. 
